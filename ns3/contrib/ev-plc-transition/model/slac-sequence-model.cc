...
// Legacy 17-message sequence (196 slots), superseded by the paper's
// message table (the corrected 19-message sequence, 230 slots). Not used
// on the paper's evaluation path; see docs/model/slac_sequence_model.md.
