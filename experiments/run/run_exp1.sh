...
EXP="exp1_csma_vs_scheduled"
CONFIG="$ROOT/experiments/configs/exp1_csma_vs_scheduled.json"
OUT="${EXP_OUT_ROOT:-$ROOT/scratch}/$EXP"  # smoke outputs stay out of results/
mkdir -p "$OUT"
